...
func TestCells(t *testing.T) {
	tests := []struct {
		...
		{"cp437", charmap.CodePage437,
			convert.Cell{"IBM Code Page 437", "cp437", "437", "msdos"}, false},
		{"latin6", charmap.ISO8859_10,
			convert.Cell{"ISO 8859-10", "iso-8859-10", "10", "latin6"}, false},
		{"utf8", unicode.UTF8,
			convert.Cell{"UTF-8", "utf-8", "", "utf8"}, false},
		{"utf32", utf32.UTF32(utf32.BigEndian, utf32.UseBOM),
			convert.Cell{"UTF-32BE (Use BOM)", "utf-32", "", "utf32"}, false},
	}
