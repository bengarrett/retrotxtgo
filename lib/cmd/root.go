...
func examples() *bytes.Buffer {
	...
	fmt.Fprintln(w, str.Example(" retrotxt view --to=cp1252 1252 > file.txt"), "will save the Windows-1252 English test with its original encoding")
	fmt.Fprintln(w, str.Example(" retrotxt view --to=cp1252 1252 | retrotxt info"), "displays statistics and information")
