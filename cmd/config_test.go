...
func Test_ConfigCommand(t *testing.T) {
	const (
		se   = "Set a text editor to launch when using config edit:"
		hFE  = "Embed the font as Base64 text within the HTML"
		hFF  = "Choose a font, automatic, mona, vga"
		hL   = "Standard: Recommended, uses external CSS"
		hMA  = "Defines the name of the page authors"
		hMCS = "Specifies one or more color schemes with which the page is compatible"
		hMD  = "A short and accurate summary of the content of the page"
		hMG  = " <meta name=\"generator\""
		hKW  = "Words relevant to the page content."
	)
	...
	tests := []struct {
		...
		{"info", inf, "\"html.meta.color_scheme\": \"\","},
		...
		{"info", inf, "\"html.meta.theme_color\": \"\","},
		{"info", inf, "\"html.title\": \"RetroTxtGo\","},
		{"info", inf, "\"save_directory\": \"\","},
		{"info", inf, "\"serve\": 8086,"},
		...
		// set config items
		{"set ed", []string{"set", "editor"}, se},
		{"set fe", []string{"set", "html.font.embed"}, hFE},
		{"set ff", []string{"set", "html.font.family"}, hFF},
		{"set lay", []string{"set", "html.layout"}, hL},
		{"set ma", []string{"set", "html.meta.author"}, hMA},
		{"set mcs", []string{"set", "html.meta.color_scheme"}, hMCS},
		{"set md", []string{"set", "html.meta.description"}, hMD},
		{"set mg", []string{"set", "html.meta.generator"}, hMG},
		{"set kw", []string{"set", "html.meta.keywords"}, hKW},
		{"set nt", []string{"set", "html.meta.notranslate"}, "notranslate"},
		{"set nf", []string{"set", "html.meta.referrer"}, "no-referrer"},
		{"set meta", []string{"set", "html.meta.retrotxt"}, "<meta name=\"retrotxt\""},
		{"set bot", []string{"set", "html.meta.robots"}, "0 for follow"},
		{"set tc", []string{"set", "html.meta.theme_color"}, "<meta name=\"theme_color\""},
		{"set tit", []string{"set", "html.title"}, "<title>RetroTxtGo</title>"},
		{"set dir", []string{"set", "save_directory"}, "Directory aliases"},
		{"set port", []string{"set", "serve"}, "Internal HTTP server port number"},
		{"set htm", []string{"set", "style.html"}, "The style.html is set to"},
		{"set inf", []string{"set", "style.info"}, "The style.info is set"},
		// setup items
